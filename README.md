...
Interactive wizard for creating new OpenCode skills with proper project structure, install/uninstall scripts, and version control support.
...
└── opencode-skill-{name}/
    ...
    ├── create-skill.sh       # This wizard script
...
Generated skills now include canonical metadata in `SKILL.toml` plus a lightweight compatibility block in `SKILL.md`.
